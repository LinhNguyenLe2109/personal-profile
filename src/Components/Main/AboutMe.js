...
const AboutMe = () =>{
    return (
        <section id={styles['about-me']} className="container-fluid">
            ...
            <div id={styles.information} className="container bg-dark bg-gradient text-light px-3 py-5 mx-auto mb-4 rounded-3 d-lg-flex col-lg-9 justify-content-around align-items-center">
