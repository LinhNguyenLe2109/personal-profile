...
const Footer =() =>{
    return (
        <footer id="footer" className={`d-flex justify-content-center align-items-center flex-column ${styles.footer}`}>
            ...
            <a href = "mailto: lelinhnguyen2109@example.com" className='btn btn-warning fs-4 mt-3 mb-4'>Contact me</a>
        </footer>
    )
